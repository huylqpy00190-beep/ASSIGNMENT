...
<div class="container">
  <div class="card">
    ...
    <div style="margin-bottom:12px;">
    	<a class="button" href="approve_news.jsp">Duyệt bài</a>
  	</div>
          ...
          %>
            <tr>
              ...
              <td style="padding:8px">
                <a class="button secondary" href="/quan-ly-tin/sua">Sửa</a>
                <a class="button secondary" href="/quan-ly-tin/xoa" onclick="return confirm('Xóa bài viết?')">Xóa</a>
              </td>
            </tr>
          <% } } else { %>
